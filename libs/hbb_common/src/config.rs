...
pub const RENDEZVOUS_SERVERS: &[&str] = &["120.36.139.102"];
pub const PUBLIC_RS_PUB_KEY: &str = "keyvboxrdesk01";
...
pub mod keys {
    ...
    pub const OPTION_API_SERVER: &str = "http://120.36.139.102:21114";
    pub const OPTION_KEY: &str = "keyvboxrdesk01";
